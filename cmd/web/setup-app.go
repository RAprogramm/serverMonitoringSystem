...
func setupApp() (*string, error) {
	...
	identifier := flag.String("identifier", "smsystem", "unique identifier")
	...
	databaseName := flag.String("db", "smsystem", "database name")
	...
	preferenceMap["version"] = SMSystemVersion
